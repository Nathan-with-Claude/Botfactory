    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // US-067/068/069 : broadcasts reçus et marquage VU (polling mobile livreur)
                        .requestMatchers(HttpMethod.GET, "/api/supervision/broadcasts/recus").hasAnyRole("LIVREUR", "SUPERVISEUR")
                        .requestMatchers(HttpMethod.POST, "/api/supervision/broadcasts/*/vu").hasAnyRole("LIVREUR", "SUPERVISEUR")
