...
| 2026-03-25 | OBS-021-01 | Correction post-QA : DevDataSeeder BC-07 — ajout deleteAll() avant les saves pour forcer la recréation des tournées à LocalDate.now() (évite les données stale en base depuis un démarrage précédent). | DevDataSeeder.java (svc-supervision) |
| 2026-03-25 | OBS-011-01 | Correction post-QA : TableauDeBordDTO restructuré — compteurs encapsulés dans sous-record BandeauResume (JSON: {"bandeau":{"actives":...},...}). SupervisionControllerTest mis à jour ($.bandeau.actives). | TableauDeBordDTO.java, SupervisionControllerTest.java |
| 2026-03-25 | OBS-024-01 | Correction post-QA : champ lancee renommé en lanceeLe dans TourneePlanifieeDTO et TourneePlanifieeDetailDTO (Interface Layer uniquement, domaine inchangé). | TourneePlanifieeDTO.java, TourneePlanifieeDetailDTO.java |
| 2026-03-25 | OBS-017-01 | Correction post-QA : EnregistrerEvenementHandler.handle() retourne EvenementLivraison. EvenementController retourne 201 avec DTO (body non vide). EvenementControllerTest mis à jour (doNothing→when/thenReturn, doThrow→when/thenThrow). | EnregistrerEvenementHandler.java, EvenementController.java, EvenementControllerTest.java |
| 2026-03-25 | TC-018-01 | Correction post-QA bonus : US-018 spec — eventId préfixé us018- + statuts acceptés étendus à [201, 409, 403] pour isolation inter-suites. | src/mobile/e2e/US-018-historisation-immuable.spec.ts |
